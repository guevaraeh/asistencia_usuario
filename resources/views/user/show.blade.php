...
@section('title')
<title>Registro de asistencias de {{ $user->name . ' ' . $user->lastname }}</title>
@endsection
    ...
    <div class="col-lg-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h5 class="card-title text-primary">Registro de asistencias de {{ $user->lastname . ' ' . $user->name }}</h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-sm-12 col-xl-8">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('user.export', $user->id) }}" class="btn btn-primary">Exportar Todo</a>
                            </div>
...
/******************************************************************************************************************************/
    ...
    var route = "{{ route('user.export_by_range', $user->id) }}"+"/";
    $("#export-excel").attr("href", route+$('#init-date').val()+"/"+$('#end-date').val());

    var route_date = "{{ route('user.export_by_date', $user->id) }}"+"/";
